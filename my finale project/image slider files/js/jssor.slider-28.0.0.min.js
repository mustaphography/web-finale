  ...
  var b = (i.$Jssor$ = new (function () {
    ...
    function Qb() {
      if (!T) {
        ...
        if (M.pointerEnabled || (a = M.msPointerEnabled))
          T.re = a ? "msTouchAction" : "touchAction";
      }
      return T;
    }
    function y(g) {
    ...
    function Jb(h, u, e) {
      ...
      function t(d, a, s, n, i) {
        ...
        if (g < h) {
          for (
            var r = D(a.lb), u = h / g, o = h - g, f = 0, p = 0;
            p < 10 && f < o;
            p++
          ) {
            var v = u + (u * p) / 10,
  ...
  var u = (i.$JssorSlideshowFormations$ = new (function () {
    ...
    i.$FormationCircle = function (d) {
      for (
        ...
        for (a = 0; a < f; a++)
          h(g, c.$Round(c.xb(c.B(b - i, 2) + c.B(a - j, 2))), [a, b]);
      return g;
    };
    ...
    j = (i.$JssorSlider$ = (i.module || {}).exports = function () {
      ...
      function cd() {
        ...
        l.call(
          ...
          -1,
          2,
          { $Easing: g.$Linear, Pc: { Pb: Fc }, hc: q, $Reverse: Hb },
          b,
          { Pb: 1 },
          { Pb: -1 }
        );
